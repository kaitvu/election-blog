...
```{r state win margin in vote share, fig.width=10, fig.height=6}
...
```{r swing margin in vote share, fig.width=10, fig.height=6}
...
```{r 2024 swing margin in vote share, fig.width=10, fig.height=5.5}
